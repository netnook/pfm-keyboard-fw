...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_ALPHA] = LAYOUT_split_4553(
        KC_ESC,        KC_F,          KC_R,           KC_M,                                                            KC_P,                  KC_U,                KC_B,          KC_BACKSPACE,
        LGUI_T(KC_W),  LALT_T(KC_A),  LSFT_T(KC_N),   LCTL_T(KC_T),         KC_V,                KC_J,                 RCTL_T(KC_S),          RSFT_T(KC_E),        LALT_T(KC_O),  RGUI_T(KC_K),
    ...
    [_LANG] = LAYOUT_split_4553(
        KC_TRNS,  XXXXXXX,      XXXXXXX,  XXXXXXX,                            XXXXXXX,      XX_UMLAUT_U,  XXXXXXX,      KC_TRNS,
        XXXXXXX,  XX_UMLAUT_A,  KC_LSFT,  XXXXXXX,  XXXXXXX,        XXXXXXX,  XX_ESZETT,    XX_EURO,      XX_UMLAUT_O,  XXXXXXX,
        XXXXXXX,  XXXXXXX,      XXXXXXX,  XXXXXXX,  XXXXXXX,        XXXXXXX,  XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX, 
                                KC_TRNS,  KC_TRNS,  KC_TRNS,        KC_TRNS,  KC_TRNS,      KC_TRNS
    ),

    [_NUM] = LAYOUT_split_4553(
        KC_TRNS,  XXXXXXX,   XXXXXXX,       KC_DEL,                                KC_7,          KC_8,          KC_9,          KC_TRNS,
        KC_LGUI,  XX_CTLA,   KC_LSFT,       XX_TAB,   C(KC_V),        KC_PERCENT,  RCTL_T(KC_4),  RSFT_T(KC_5),  LALT_T(KC_6),  XX_PI,
        C(KC_X),  C(KC_Y),   C(KC_Z),       C(KC_S),  C(KC_C),        KC_0,        KC_1,          KC_2,          KC_3,          XXXXXXX,
                             KC_TRNS,       KC_TRNS,  KC_TRNS,        KC_COMMA,    KC_DOT,        KC_TRNS
    ),

   [_SYMBOLS] = LAYOUT_split_4553(
        KC_TRNS,      KC_EQUAL,     KC_QUESTION,  KC_EXCLAIM,                                     KC_LEFT_BRACKET,      KC_RIGHT_BRACKET,      KC_GRAVE,         KC_TRNS,
        XX_AMPERSAND, XX_SLASH,     KC_MINUS,     XX_COLON,        KC_DOLLAR,     KC_CIRCUMFLEX,  XX_LEFT_PAREN,        KC_RIGHT_PAREN,        XX_DOUBLE_QUOTE,  XX_LEFT_ANGLE_BRACKET,
